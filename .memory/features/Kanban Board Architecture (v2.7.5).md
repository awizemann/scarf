...
- [gating] Single flag HermesCapabilities.hasKanban (>= 0.12.0) gates all 27 v0.12 verbs together. hasKanbanV015 gates the v0.15 maturation wave. hasKanbanSessionFilter gates the chat-scoped board. hasKanbanGoalMode gates goal-mode tasks (v0.16+). Global Kanban sidebar + per-project Kanban tab stay on hasKanban (tenant-scoped) — only chat-scoped surface requires v0.15 #gating
