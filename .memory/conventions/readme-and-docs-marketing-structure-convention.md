...
- [todo] **REGRESSION 2026-09-02** — wiki/Home.md stacks Latest (v3.1.0) + Previous (v3.0.1) + Earlier (v3.0.0) in one paragraph. Restore compliance: wiki/Home.md keeps v3.1.0 only, move older summaries to Release-Notes-Index link. #releases
