...
## Observations
- [current-target] Scarf targets Hermes v0.21.0 (v2026.8.31) as of shipped v3.1.0 — landed through a series of capability flag additions across v0.18 (v2026.7.1), v0.19 (v2026.7.20), v0.20 (v2026.8.3), v0.20.3 (v2026.8.16.2), v0.20.4 (v2026.8.18), v0.20.5 (v2026.8.19), v0.20.6 (v2026.8.27), and v0.21 (v2026.8.31). All versions v0.6.0 through v0.21.0 are verified; older hosts degrade gracefully. NOTE: the vendored hermes-agent checkout at ~/Developer/ScarfBox/Vendor/hermes-agent may sit on an older tag — `git show <target-tag>:<path>` or a detached worktree when verifying against v0.21.0 #target
