...
- skill_installed / template_installed {source: hub|url|bundled}
...
### Diagnostics (.diagnostics consent)
...
2. Visible opt-out: setEnabled(false) master switch + setConsent groups.
